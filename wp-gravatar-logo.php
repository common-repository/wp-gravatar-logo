...
if ( ! class_exists( 'WP_Gravatar_Logo' ) ) :
	...
	final class WP_Gravatar_Logo {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'wp-gravatar-logo' ), '1.6' );
		}
		...
		private function constants() {
			$this->define( 'WP_GRAVATAR_LOGO_VERSION', '1.0.2' );
		...
		function plugin_action_links( $links, $file ) {
			...
			$settings_link = '<a href="' . esc_url( admin_url( 'customize.php?autofocus[section]=title_tagline' ) ) . '">' . esc_html__( 'Customize', 'wp-gravatar-logo' ) . '</a>';
		...
		public function load_textdomain() {
			load_plugin_textdomain( 'wp-gravatar-logo', false, dirname( plugin_basename( WP_GRAVATAR_LOGO_PLUGIN_DIR ) ) . '/languages/' );
		}
	}
